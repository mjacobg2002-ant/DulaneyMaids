...
import { ArrowRight, Building2, CalendarCheck, Users, Home, HeartPulse, Leaf, Settings2, Phone } from 'lucide-react';
...
const HERO_IMG = 'https://images.unsplash.com/photo-1603712725038-e9334ae8f39f?w=1200&h=550&q=70&fit=crop&auto=format';
...
export function Commercial() {
  const featuredAreas = cities.filter((c) =>
    ['kettering-md', 'largo-md', 'upper-marlboro-md', 'bowie-md', 'washington-dc', 'arlington-va'].includes(c.slug)
  );
  ...
  return (
    <div>
      <Seo
        title="Commercial Cleaning & Janitorial Services | Prince George's County, MD"
        description="Commercial cleaning and janitorial services for offices, apartment communities, and facilities in Prince George's County, Washington DC, and Northern Virginia. Tailored programs, insured team, free quotes."
        path="/commercial"
        jsonLd={serviceSchema({
          name: 'Commercial & Janitorial Cleaning',
          description:
            'Recurring janitorial programs, office cleaning, apartment community services, and facility maintenance across Prince George\u2019s County, Washington DC, and Northern Virginia.',
          path: '/commercial',
        })}
      />
      ...
      <section className="relative bg-[#143177]">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 lg:px-10 py-20 lg:py-24">
          ...
          >
            Commercial Cleaning · Prince George's County & the DMV
          </motion.p>
          <motion.h1
          ...
          >
            Dependable cleaning and facility support for apartment communities, office buildings, assisted
            living facilities, and commercial properties across Prince George's County and the DMV. We help you
            maintain clean, healthy, professional environments that leave a lasting impression on residents,
      ...
      <section className="py-16 bg-[#F6F8FC]">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <motion.h2
            ...
            {...inView()}
          >
            Commercial Cleaning Across Prince George's County & the DMV
          </motion.h2>
